...
<html>
  <head>
    <title>SISTEM ESTIMASI KUAT TEKAN BETON</title>
...
<nav class="navbar navbar-default" role="navigation">
  ...
  <!-- Collect the nav links, forms, and other content for toggling -->
      ...
      <div class="container">
          ...
          <div class="col-md-5">
              ...
              <tr><td align="center">
              <img src="<?php echo base_url().'/img/logo.png'; ?>" width="30%" />
              <h2>Sistem Estimasi Kuat Tekan Beton</h2></td></tr>
              <tr><td>  
  ...
  <span class="input-group-addon"><i class="fa fa-keyboard-o"></i></span>
              ...
              <tr><td align="center"><input type="submit" name="submit" value="Login" class="btn btn-danger"></td></tr>
          </table>   
          </form>
          </div>    
           <div class="col-md-3"></div>
